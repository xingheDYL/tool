...
public class MainWindow {
    ...
    public void init() {
        ...
        mainWindow.getCryptoPanel1().add(CryptoForm1.getInstance().getCryptoPanel1(), gridConstraints);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        cryptoPanel1.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        tabbedPane.addTab("测试", cryptoPanel1);
